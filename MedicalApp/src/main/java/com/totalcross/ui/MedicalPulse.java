	...
	public void initUI() {
		...
		containerLayout.setCustomInitUI(new CustomInitUI() {
			...
			public void postInitUI(XmlContainerLayout container) {
				...
				container.getControlByID("@+id/heartLabel").setFont(Fonts.BARLOW_CONDENSED_17);
				container.getControlByID("@+id/maxBPMLabel").setFont(Fonts.BARLOW_CONDENSED_25);
				container.getControlByID("@+id/minBPMLabel").setFont(Fonts.BARLOW_CONDENSED_25);
